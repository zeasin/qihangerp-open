...
<!--      <el-table-column label="平台SKU ID" align="center" prop="skuId" />-->
      ...
      <el-table-column label="标题" align="center" prop="skuName" />
...
<!--        </template>-->
<!--      </el-table-column>-->
      <el-table-column label="SKU属性" align="center" prop="saleAttrs" >
        <template slot-scope="scope">
          <el-tag size="small" v-if="scope.row.saleAttrs && scope.row.saleAttrs!=='null'" v-for="item in JSON.parse(scope.row.saleAttrs)">{{item.attrValueAlias}}</el-tag>
        </template>
      </el-table-column>
