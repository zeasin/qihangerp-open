<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="类型" prop="disputeType">
        <el-select v-model="queryParams.disputeType" placeholder="请选择状态" clearable @change="handleQuery">
          <el-option label="仅退款" value="REFUND" ></el-option>
          <el-option label="退货退款" value="REFUND_AND_RETURN"></el-option>
          <el-option label="换货" value="TMALL_EXCHANGE"> </el-option>
          <el-option label="维修" value="REPAIR"> </el-option>
          <el-option label="补寄" value="RESHIPPING"> </el-option>
